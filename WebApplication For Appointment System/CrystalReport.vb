...
Public Class CrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WebApplication_For_Appointment_System.CrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateRange() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReport = New CrystalReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
